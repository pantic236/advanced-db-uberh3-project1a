...
class AutoSimulator:
    ...
    def move(self, debug_print=False):
        ...
        if debug_print:
            print(
                f"Trenutni segment: {self.current_segment}, Duzina Segmenta: {segment_length}, Step_distance: {self.distance_per_step}, Progres: {self.progress:.2f}, Increment: {progress_increment:.2f}")
